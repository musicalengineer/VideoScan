...
// Catalog tab helper views: content table + preview, rename/notes sheets,
// discover-volumes sheet, scan-options menu, shared media-open helpers.
// (Toolbar → CatalogToolbar.swift, inspector → InspectorPanel.swift,
// 2026-06-11 file-split refactor.)
